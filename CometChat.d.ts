...
export class CometChat {
        ...
        static TypingNotification: typeof TypingIndicator;
        ...
        /**
            ...
            * @memberof CometChat
            */
        static sendMessage(message: TextMessage | MediaMessage | any): Promise<{}>;
        /**
        ...
        /**
            ...
            * @memberof CometChat
            */
        static joinGroup(grp: any, type?: GroupType, password?: string): Promise<{}>;
        /**
            *
...
export const APP_SETTINGS: {
    ...
    KEYS: {
        ...
        CALL_SERVICE: string;
        XMPP_WS_PORT: string;
        XMPP_WSS_PORT: string;
        XMPP_HTTP_BIND_PORT: string;
        XMPP_HTTPS_BIND_PORT: string;
        API_HOST: string;
        KOHOUTEK_HOST: string;
        WEBRTC_HOST: string;
...
export class GroupMember {
    constructor(guid: string, uid: string);
    setGuid(guid: string): void;
    setUid(uid: string): void;
