...
<a href=" "> <img src="https://img.shields.io/badge/Version-3.0.0-beta4-important" /></a>
...
```javascript
	npm install @cometchat-pro/chat@3.0.0-beta4 --save
```
</li>
...
```html
  <script type="text/javascript" src="https://unpkg.com/@cometchat-pro/chat@3.0.0-beta4/CometChat.js"></script>
```
